...
class PlayerMusicAlbumSimpleRoute extends StatefulWidget {
  ...
  @override
  PlayerMusicAlbumSimpleRouteState createState() =>
      new PlayerMusicAlbumSimpleRouteState();
}

class PlayerMusicAlbumSimpleRouteState
    extends State<PlayerMusicAlbumSimpleRoute> {
  double value1 = 0.3;
              ...
              CircleAvatar(
                ...
                child: CircleAvatar(
                  ...
                  child: CircleAvatar(
                    radius: 120,
                    backgroundImage:
                        AssetImage(Img.get("photo_singer_male.jpg")),
                  ),
                ),
              ),
              Container(height: 20),
