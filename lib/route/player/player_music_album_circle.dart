...
class PlayerMusicAlbumCircleRoute extends StatefulWidget {
  ...
  @override
  PlayerMusicAlbumCircleRouteState createState() =>
      new PlayerMusicAlbumCircleRouteState();
}

class PlayerMusicAlbumCircleRouteState
    extends State<PlayerMusicAlbumCircleRoute> {
  double value1 = 0.3;
      ...
      body: Stack(
        children: <Widget>[
          Container(
            ...
            child: Image.asset(Img.get('photo_singer_female.jpg'),
                fit: BoxFit.cover),
          ),
          Container(
            width: double.infinity,
            ...
            children: <Widget>[
              ...
              CircleAvatar(
                ...
                child: CircleAvatar(
                  radius: 90,
                  backgroundImage:
                      AssetImage(Img.get("photo_singer_female.jpg")),
                ),
              ),
              Container(height: 20),
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Text("0:00",
                        style:
                            TextStyle(fontSize: 14, color: MyColors.grey_60)),
                    IconButton(
