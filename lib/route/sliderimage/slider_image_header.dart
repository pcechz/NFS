...
class SliderImageHeaderRoute extends StatefulWidget {
  ...
  @override
  SliderImageHeaderRouteState createState() =>
      new SliderImageHeaderRouteState();
}
              ...
              child: Container(
                ...
                child: Stack(
                  children: <Widget>[
                    PageView(
                      children: <Widget>[
                        Image.asset(Img.get('image_shop_9.jpg'),
                            fit: BoxFit.cover),
                        Image.asset(Img.get('image_shop_10.jpg'),
                            fit: BoxFit.cover),
                        Image.asset(Img.get('image_shop_11.jpg'),
                            fit: BoxFit.cover),
                        Image.asset(Img.get('image_shop_12.jpg'),
                            fit: BoxFit.cover),
                        Image.asset(Img.get('image_shop_13.jpg'),
                            fit: BoxFit.cover),
                      ],
