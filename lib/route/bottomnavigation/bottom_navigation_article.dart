...
import 'package:app/included/include_releases_content.dart';
...
class BottomNavigationArticleRoute extends StatefulWidget {
  ...
  @override
  BottomNavigationArticleRouteState createState() =>
      new BottomNavigationArticleRouteState();
}

class BottomNavigationArticleRouteState
    extends State<BottomNavigationArticleRoute>
              ...
              child: SingleChildScrollView(
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      Text(
                          "Fusce Aliquam Blandit? Urna Quis Pulvinar. Donec Luctus Tincidunt eu Condimentum",
                          style: MyText.headline(context).copyWith(
                              color: MyColors.grey_90,
                              fontWeight: FontWeight.bold)),
                      Container(height: 10),
                      Text(
                          "Quisque sapien lorem, vestibulum vitae justo eget, fringilla eleifend nisi. Nam fermentum ipsum vitae ligula",
