...
import 'package:app/included/include_releases_content_dark.dart';
import 'package:app/model/bottom_nav.dart';
...
class BottomNavigationBasicState extends State<BottomNavigationDarkRoute>
    with TickerProviderStateMixin<BottomNavigationDarkRoute> {
  int currentIndex = 0;
  BuildContext ctx;
