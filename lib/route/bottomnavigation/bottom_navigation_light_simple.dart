...
class BottomNavigationLightSimpleRoute extends StatefulWidget {
  ...
  @override
  BottomNavigationLightSimpleRouteState createState() =>
      new BottomNavigationLightSimpleRouteState();
}

class BottomNavigationLightSimpleRouteState
    extends State<BottomNavigationLightSimpleRoute>
                      ...
                      Row(
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            width: 7,
                            child:
                                CircleAvatar(backgroundColor: MyColors.grey_20),
                          ),
                          Container(
                            margin: EdgeInsets.symmetric(horizontal: 5),
                            height: 7,
