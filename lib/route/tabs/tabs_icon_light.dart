...
class TabsIconLightRouteState extends State<TabsIconLightRoute>
    ...
    return Scaffold(
      ...
      body: NestedScrollView(
        ...
        headerSliverBuilder: (BuildContext context, bool innerBoxIsScroller) {
          return <Widget>[
            SliverAppBar(
              title: Text(title, style: TextStyle(color: MyColors.grey_60)),
              pinned: true,
              floating: true,
              ...
              bottom: TabBar(
                ...
                labelStyle: MyText.subhead(context).copyWith(
                    fontWeight: FontWeight.bold, color: Colors.deepOrange[500]),
