...
class FormWithIconRouteState extends State<FormWithIconRoute> {
  TextStyle textStyle =
      TextStyle(color: Colors.pink[800], height: 1.4, fontSize: 16);
  TextStyle labelStyle = TextStyle(color: Colors.pink[800]);
  UnderlineInputBorder lineStyle1 = UnderlineInputBorder(
      borderSide: BorderSide(color: Colors.pink[800], width: 1));
                  ...
                  children: <Widget>[
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        icon: Container(
                            child:
                                Icon(Icons.domain, color: Colors.transparent),
                            margin: EdgeInsets.fromLTRB(0, 15, 0, 0)),
                        labelText: "Title",
                        labelStyle: labelStyle,
                        enabledBorder: lineStyle1,
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        icon: Container(
                            child: Icon(Icons.public, color: MyColors.grey_60),
                            margin: EdgeInsets.fromLTRB(0, 15, 0, 0)),
                        labelText: "Website",
                        labelStyle: labelStyle,
                        enabledBorder: lineStyle1,
