...
class ArticleStepperRouteState extends State<ArticleStepperRoute> {
          ...
          Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                IconButton(
                  icon:
                      Icon(Icons.chat_bubble_outline, color: MyColors.grey_60),
                  onPressed: () {},
                ),
              ],
            ),
  ...
  Widget buildPageTitle() {
    return Container(
      child: Stack(
        children: <Widget>[
          Image.asset(Img.get('image_28.jpg'),
              fit: BoxFit.cover,
              height: double.infinity,
              width: double.infinity),
          Container(
          ...
          Align(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text("Elizabeth".toUpperCase(),
                      style: MyText.subhead(context)
                          .copyWith(color: MyColors.grey_10)),
                  Text("Interdum Lectus Bibendum Suspendisse Potenti Nec.",
