...
class AboutCompanyImageRoute extends StatefulWidget {
  ...
  @override
  AboutCompanyImageRouteState createState() =>
      new AboutCompanyImageRouteState();
}
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Container(
                            width: 220,
                            child: Text(
                                "Fusce Dictum Tristique Elit Nec Laculis",
                  ...
                  child: Column(
                    children: <Widget>[
                      CircleAvatar(
                        radius: 25,
                        backgroundImage:
                            AssetImage(Img.get('photo_male_2.jpg')),
                      ),
                      Container(height: 8),
                      Text("Adams G",
                  ...
                  child: Column(
                    children: <Widget>[
                      CircleAvatar(
                        radius: 25,
                        backgroundImage:
                            AssetImage(Img.get('photo_male_3.jpg')),
                      ),
                      Container(height: 8),
                      Text("Miller W",
                          style: MyText.caption(context).copyWith(
                  ...
                  child: Column(
                    children: <Widget>[
                      CircleAvatar(
                        radius: 25,
                        backgroundImage:
                            AssetImage(Img.get('photo_male_5.jpg')),
                      ),
                      Container(height: 8),
                      Text("Kevin John",
                          style: MyText.caption(context).copyWith(
