...
class DialogCustomLightRoute extends StatefulWidget {
  ...
  @override
  DialogCustomLightRouteState createState() =>
      new DialogCustomLightRouteState();
}
...
class DialogCustomLightRouteState extends State<DialogCustomLightRoute> {
  ...
  void onItemClick(int index, People obj) {
    //showDialog(context: context, child: CustomEventDialog(obj));
  }
  ...
  void initState() {
    ...
    Future.delayed(Duration(seconds: 1), () {
      // showDialog(context: context, child: CustomEventDialog(items[0]));
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      appBar: AppBar(
          ...
          title:
              Text("Custom Light", style: TextStyle(color: MyColors.grey_60)),
          leading: IconButton(
