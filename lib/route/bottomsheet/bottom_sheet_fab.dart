                  ...
                  children: <Widget>[
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Container(width: 10),
                          Icon(Icons.location_on, color: MyColors.grey_20),
                          Container(width: 20),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Container(width: 10),
                          Icon(Icons.phone, color: MyColors.grey_20),
                          Container(width: 20),
                          Text("(415) 349-0942",
                              style: MyText.medium(context)
                                  .copyWith(color: MyColors.grey_90)),
                    ...
                    Container(
                      ...
                      child: Row(
                        children: <Widget>[
                          Container(width: 10),
                          Icon(Icons.schedule, color: MyColors.grey_20),
                          Container(width: 20),
                          Text("Wed, 10 AM - 9 PM",
                              style: MyText.medium(context)
                                  .copyWith(color: MyColors.grey_90)),
