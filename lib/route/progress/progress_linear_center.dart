...
import 'package:app/adapter/my_files_adapter.dart';
import 'package:app/model/folder_file.dart';
...
class ProgressLinearCenterRoute extends StatefulWidget {
  ...
  @override
  ProgressLinearCenterRouteState createState() =>
      new ProgressLinearCenterRouteState();
}
...
class ProgressLinearCenterRouteState extends State<ProgressLinearCenterRoute> {
  ...
  void initState() {
    ...
    items.add(new FolderFile(
        "Vacation itinerary", "Jan 20, 2014", Icons.insert_drive_file, false));
    items.add(new FolderFile(
        "Kitchen Remodel", "Jan 10, 2014", Icons.insert_drive_file, false));
    items.add(new FolderFile(
        "To Do Note", "Des 25, 2013", Icons.insert_drive_file, false));
  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      appBar: AppBar(
          bottom: PreferredSize(
              child: Container(
                ...
                child: Text("My files",
                    style:
                        MyText.headline(context).copyWith(color: Colors.white)),
              ),
      ...
      floatingActionButton: FloatingActionButton(
          mini: true, child: Icon(Icons.add), onPressed: () {}),
        ...
        child: Column(
          ...
          children: <Widget>[
            Text("Getting your files",
                style:
                    MyText.subhead(context).copyWith(color: Colors.grey[800])),
            Container(height: 20),
            Container(
              height: 4,
