...
class ProfileDrawerImageRoute extends StatefulWidget {
  ...
  @override
  ProfileDrawerImageRouteState createState() =>
      new ProfileDrawerImageRouteState();
}
...
class ProfileDrawerImageRouteState extends State<ProfileDrawerImageRoute> {
  ...
  Widget build(BuildContext context) {
    ...
    Widget widget = Scaffold(
      ...
      appBar: new AppBar(title: new Text("Drawer News"), actions: <Widget>[
        IconButton(
                            ...
                            Row(
                              ...
                              children: <Widget>[
                                Icon(Icons.location_on,
                                    color: MyColors.grey_10, size: 12),
                                Container(width: 5),
