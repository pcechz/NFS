...
class PaymentCardCollectionsRoute extends StatefulWidget {
  ...
  @override
  PaymentCardCollectionsRouteState createState() =>
      new PaymentCardCollectionsRouteState();
}

class PaymentCardCollectionsRouteState
    extends State<PaymentCardCollectionsRoute> {
  int page = 0;
  ...
  static const List<String> expire_array = ["08/20", "11/23", "05/19", "06/25"];

  static const List<String> cvv_array = ["771", "098", "334", "558"];

  static const List<String> logo_array = [
    "ic_visa_new.png",
    "ic_mastercard_new.png",
    "ic_mastercard_new.png",
    "ic_visa_new.png"
  ];
                  ...
                  Row(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        width: 50,
                        height: 30,
                        child: Image.asset(Img.get(logo_array[index]),
                            fit: BoxFit.cover),
                      )
                    ],
                  ),
                  Container(height: 10),
                  Text(postfix_array[index],
                      style: MyText.headline(context).copyWith(
