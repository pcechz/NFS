...
import 'package:app/adapter/list_category_image_adapter.dart';
import 'package:app/data/dummy.dart';
import 'package:app/data/my_colors.dart';
import 'package:app/model/shop_category.dart';
...
class ShoppingCategoryImageRoute extends StatefulWidget {
  ...
  @override
  ShoppingCategoryImageRouteState createState() =>
      new ShoppingCategoryImageRouteState();
}

class ShoppingCategoryImageRouteState
    extends State<ShoppingCategoryImageRoute> {
