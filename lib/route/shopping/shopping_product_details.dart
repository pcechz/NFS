...
class ShoppingProductDetailsRoute extends StatefulWidget {
  ...
  @override
  ShoppingProductDetailsRouteState createState() =>
      new ShoppingProductDetailsRouteState();
}

class ShoppingProductDetailsRouteState
    extends State<ShoppingProductDetailsRoute> with TickerProviderStateMixin {
            ...
            SliverAppBar(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                background: Column(
                  ...
                  children: <Widget>[
                    Expanded(
                      child: Image.asset(Img.get('image_shop_10.jpg'),
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    Icon(Icons.error_outline,
                        size: 25.0, color: MyColors.grey_60),
                    Container(width: 20),
                    Text("Description",
                    ...
                    children: <Widget>[
                      Row(
                        children: <Widget>[
                          Container(width: 65),
                          Flexible(
                              flex: 1, child: Text(MyStrings.invoice_address)),
                          Container(width: 20)
                        ],
                      ),
                      Container(height: 15),
