...
class UpdatesPage extends StatefulWidget {
  UpdatesPage({Key key, this.title}) : super(key: key);
...
class _UpdatesPageState extends State<UpdatesPage> {
  ...
  //   super.initState();
  // }
  List<StoryItem> item = List<StoryItem>();
        ...
        [
          ...
          StoryItem.pageImage(
            CachedNetworkImageProvider(
              _newsArticles[0].urlToImage,
            ),
            caption: _newsArticles[0].title,
            //: "Update Details",
          ),

          StoryItem.pageImage(
            CachedNetworkImageProvider(
              _newsArticles.length >= 1 ? _newsArticles[1].urlToImage : "",
            ),
            caption: _newsArticles.length >= 1
                ? _newsArticles[1].title
                : "Update Details",
          ),
          // StoryItem.pageImage(
          //   CachedNetworkImageProvider(
          //     _newsArticles[1].urlToImage ??
          //         "https://i0.pickpik.com/photos/836/957/310/adventure-jump-hipster-ext-preview.jpg",
          //   ),
          //   caption: _newsArticles[1].title ?? "Update Details",
          // ),
          // StoryItem.pageImage(
          //   CachedNetworkImageProvider(
          //     _newsArticles[2].urlToImage ??
          //         "https://i0.pickpik.com/photos/836/957/310/adventure-jump-hipster-ext-preview.jpg",
          //   ),
          //   caption: _newsArticles[2].title ?? "Update Details",
          // ),
          // StoryItem.pageImage(
          //   CachedNetworkImageProvider(
          //     _newsArticles[3].urlToImage ??
          //         "https://i0.pickpik.com/photos/836/957/310/adventure-jump-hipster-ext-preview.jpg",
          //   ),
          //   caption: _newsArticles[3].title ?? "Update Details",
          // ),
          // StoryItem.pageImage(
          //   CachedNetworkImageProvider(
          //     _newsArticles[4].urlToImage ??
          //         "https://i0.pickpik.com/photos/836/957/310/adventure-jump-hipster-ext-preview.jpg",
          //   ),
          //   caption: _newsArticles[4].title ?? "Update Details",
          // ),
