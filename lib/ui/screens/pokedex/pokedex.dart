...
import 'package:app/configs/durations.dart';
import 'package:app/configs/images.dart';
import 'package:app/core/extensions/animation.dart';
import 'package:app/core/extensions/context.dart';
import 'package:app/domain/entities/pokemon.dart';
import 'package:app/providers/providers.dart';
import 'package:app/routers/routes.dart';
import 'package:app/ui/modals/generation_modal.dart';
import 'package:app/ui/modals/search_modal.dart';
import 'package:app/ui/screens/pokedex/widgets/pokemon_card.dart';
import 'package:app/ui/widgets/fab.dart';
import 'package:app/ui/widgets/poke_container.dart';

part 'package:app/ui/screens/pokedex/widgets/fab_menu.dart';
part 'package:app/ui/screens/pokedex/widgets/fab_overlay_background.dart';
part 'package:app/ui/screens/pokedex/widgets/header_app_bar.dart';
      ...
      child: Consumer(builder: (_, watch, __) {
        ...
        return _PokemonGrid(
          ...
          onSelectPokemon: (index, pokemon) {
            context
                .read(currentPokemonStateProvider)
                .setPokemon(index, pokemon);
            // AppNavigator.push(Route.pokemonInfo, pokemon);
          },
        );
      }),
    );
