...
import 'package:app/configs/types.dart';
import 'package:app/ui/screens/types/redirector.dart';
import 'package:app/ui/screens/types/type_container.dart';
import 'package:app/ui/screens/types/type_entities/widget_list.dart';
      ...
      children: [
        ...
        if (types[index].superEffective.isNotEmpty)
          Column(
            ...
            children:
                lister(index, 2, width, "Effective Against".toUpperCase()),
          ),
        Column(
          crossAxisAlignment: CrossAxisAlignment.center,
        ...
        if (types[index].nilEffective.isNotEmpty)
          Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.center,
            children:
                lister(index, 0, width, "No Effect Against".toUpperCase()),
          ),
