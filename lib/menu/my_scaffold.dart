...
import 'package:app/components/common/button/raised_gradient_button.dart';
import 'package:app/components/common/style/styles.dart';
import 'package:app/repositories/MenuRepository.dart';
                            ...
                            children: <Widget>[
                              ConstrainedBox(
                                ...
                                child: Column(
                                  ...
                                  children: <Widget>[
                                    Text(
                                      'nfs | Flutter UI Theme / Template App | Multipurpose Starter App',
                                      style: TextStyle(
                                          color: Styles.helperTextColor,
                                          fontSize: Styles.h2,
                                    ...
                                    Row(
                                      ...
                                      children: <Widget>[
                                        InkWell(
                                          ...
                                          onTap: () {
                                            _launchURL(
                                                'https://codecanyon.net/user/creativeform/portfolio');
                                          },
                                        ),
                                        InkWell(
                                          child: Container(
                                          ...
                                          onTap: () {
                                            _launchURL(
                                                'http://csform.com/flutter-all-theme/flutter-nfs/documetation/');
                                          },
                                        )
                                      ],
                                    )
